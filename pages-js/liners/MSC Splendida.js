...
function to_right(){
  ...
  first_photo.src = "../../img/msc-splendia-left-" + click[a] + ".webp";
}
...
function to_right_under(){
  ...
  second_photo.src = "../../img/msc-splendia-right-" + under[b] + ".avif";
}
