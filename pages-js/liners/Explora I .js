...
//     a = 0;
//   }
//   first_photo.src = "../../img/virtuosa-left-" + click[a] + ".avif";
// }
...
var b = "0";
let under = ["first", "second","third", "fourth"];
...
function to_right_under(){
  ...
  second_photo.src = "../../img/explora-right-" + under[b] + ".jpeg";
}
